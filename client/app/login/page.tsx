          ...
          >
            <motion.div variants={item} className="space-y-4">
              ...
              <h1 className="text-5xl xl:text-6xl font-black tracking-tighter leading-[0.9] text-foreground">
                ELEVATE YOUR <br />
                <span className="text-gradient uppercase">TRAJECTORY.</span>
              </h1>
              <p className="text-muted-foreground text-lg font-medium leading-relaxed">
                Log in to access your AI-powered career optimization suite and
                match history.
              </p>
            </motion.div>
            ...
            <motion.div variants={item} className="space-y-3">
              {[
                "Smart Ranking Match Score",
                "Keyword Extraction & Gap Detection",
                "Stored Analysis History Logs",
              ].map((feature, i) => (
                <div
                  key={i}
